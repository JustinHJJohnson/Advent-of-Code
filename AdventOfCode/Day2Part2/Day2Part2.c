...
int main(int argc, char* argv[])
{
	...
	const int inputLength = 999;//Length of the input array
	...
	//Loop over every password in the array
	for (int i = 0; i <= inputLength; i++)
	{
		...
		char c = 'a';			//The security character
		...
		if ((input[i][pos1] == c && input[i][pos2] != c) || (input[i][pos1] != c && input[i][pos2] == c)) numValidPasswords++;
		/*if ((input[i][pos1] == c && input[i][pos2] != c) || (input[i][pos1] != c && input[i][pos2] == c))
		{
			numValidPasswords++;
			printf("Valid %d-%d %c  %c %c\n", pos1 - startPassword, pos2 - startPassword, c, input[i][pos1], input[i][pos2]);
		}
		else
		{
			printf("%d-%d %c\n", pos1 - startPassword, pos2 - startPassword, c);
		}*/

	}

	printf("%d passwords are valid", numValidPasswords);
}