...
int main(int argc, char* argv[])
{
	...
	for (int i = 0; i <= inputLength; i++)
	{
		...
		for (int j = charIndex + 3; j <= strlen(input[i]); j++)
		{
			if (input[i][j] == c) numValidateChar++;
		}
